...
import com.example.petstorerest.exception.InvalidDataException;
...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(InvalidIdentifierException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<String> handleInvalidIdentifier(HttpServletRequest request, Exception ex)
    {
